...
namespace SigGolfCandidate.SphincsAllMessagesBridge.QueryFootprint
...
#guard_msgs (whitespace := lax) in
#print axioms SigGolfCandidate.SphincsAllMessagesBridge.QueryFootprint.eagerFootprint_empty
/-- info: 'SigGolfCandidate.SphincsAllMessagesBridge.QueryFootprint.sharedOracle_union_bound' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs (whitespace := lax) in
#print axioms SigGolfCandidate.SphincsAllMessagesBridge.QueryFootprint.sharedOracle_union_bound
