...
import SigGolfCandidate.Hypertree.CachedFinish
import SigGolfCandidate.Hypertree.CachedCheck
namespace SigGolfCandidate.Hypertree.CachedInvariant
...
theorem prepare_current (s : MachineState) (base : s.getReg .x28 = 0x80438)
    (ready : CachedPrepare.Ready s) : Current (CachedPrepare.state s) := by
  obtain ⟨h0,h1,h2,h3⟩ := ready
  unfold Current
  simp only [CachedPrepare.mem s base]
  simpa using And.intro h0 (And.intro h1 (And.intro h2 h3))

theorem finish_mem (s : MachineState) (base : s.getReg .x28 = 0x80018) (a : Word) :
    (CachedFinish.finish s).getMem a =
  ...
  simp [CachedFinish.finish, execInstrBr, signExtend12, signExtend21, base,
    MachineState.getReg_setReg_eq, MachineState.getReg_setReg_ne]

theorem finish_ready (s : MachineState) (base : s.getReg .x28 = 0x80018)
    (current : Current s) : CachedPrepare.Ready (CachedFinish.finish s) := by
...
theorem check_ready (s : MachineState) (ready : CachedPrepare.Ready s) :
    CachedPrepare.Ready (CachedCheck.shortCheck s) := by
  simpa only [CachedPrepare.Ready, CachedCheck.short_mem] using ready
...
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.prepare_current' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms prepare_current
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.finish_mem' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms finish_mem
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.finish_ready' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms finish_ready
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.check_ready' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms check_ready
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.full_prepare_current' depends on axioms: [propext, Quot.sound] -/
#guard_msgs in
#print axioms full_prepare_current
/-- info: 'SigGolfCandidate.Hypertree.CachedInvariant.hash_current' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms hash_current
end SigGolfCandidate.Hypertree.CachedInvariant
