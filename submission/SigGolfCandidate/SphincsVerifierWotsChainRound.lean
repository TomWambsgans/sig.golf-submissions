...
namespace SigGolfCandidate.SphincsVerifierWotsChainRoundGeneral
open SigGolf SigGolf.Riscv RiscvZkvm.Rv64
...
theorem chainRound_general (hash : Hash) (state : MachineState)
    (sourceBase : Nat)
...
/-- info: 'SigGolfCandidate.SphincsVerifierWotsChainRoundGeneral.chainRound_general' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
#print axioms chainRound_general

end SigGolfCandidate.SphincsVerifierWotsChainRoundGeneral
