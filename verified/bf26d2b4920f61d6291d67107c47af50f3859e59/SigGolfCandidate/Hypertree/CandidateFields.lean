...
theorem verificationBound : submission.VerificationBound 2870203 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 2870203 :=
