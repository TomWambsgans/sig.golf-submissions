...
theorem chain_loop (hash : Hash) (s : MachineState) (level tree start remaining : Nat)
    ...
    ∃ final, Trace hash verify s (59*remaining+5) (66*remaining+5) remaining remaining final ∧
      final.pc = 0x163c ∧
...
theorem chain_from_digit (hash : Hash) (s : MachineState) (level tree : Nat)
    ...
    ∃ final, Trace hash verify s (59*(7-digit.val)+5) (66*(7-digit.val)+5) (7-digit.val) (7-digit.val) final ∧
      final.pc = 0x163c ∧
