...
theorem verificationBound : submission.VerificationBound 5617759 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 5617759 :=
