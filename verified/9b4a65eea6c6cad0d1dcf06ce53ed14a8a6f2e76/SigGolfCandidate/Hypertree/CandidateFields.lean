...
theorem verificationBound : submission.VerificationBound 3414019 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 3414019 :=
