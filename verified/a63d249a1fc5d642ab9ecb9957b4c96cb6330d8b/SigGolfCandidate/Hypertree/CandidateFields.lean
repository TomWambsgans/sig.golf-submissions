...
theorem verificationBound : submission.VerificationBound 2276773 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 2276773 :=
