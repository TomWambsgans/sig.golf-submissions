...
theorem compressionBounds : submission.CompressionBounds := by
  ...
  | sign => change 114920≤BUDGET_SIGN; decide
...
theorem verificationBound : submission.VerificationBound 1783305 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 1783305 :=
