...
theorem chain_compute (image : Image) (hash : Hash) (p : Word) (code : ChainCode image p)
    ...
    ∃ final, Trace hash image s 51 58 1 1 final ∧ final.pc = p+284 ∧
  ...
  have headTrace := FastChainHeader.block image (p+44) code.2.1 copied cpc
...
/-- info: 'SigGolfCandidate.Hypertree.FastHeaderChain.chain_compute' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms chain_compute
end SigGolfCandidate.Hypertree.FastHeaderChain
