...
namespace SigGolfCandidate.Hypertree.InplaceInitialData
...
theorem compute (image : Image) (hash : Hash) (p : Word)
    (prepareCode : InplaceInitialPrepare.Code image p) (coreCode : InplaceCore.Code image (p+236))
...
/-- info: 'SigGolfCandidate.Hypertree.InplaceInitialData.compute' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms compute
end SigGolfCandidate.Hypertree.InplaceInitialData
