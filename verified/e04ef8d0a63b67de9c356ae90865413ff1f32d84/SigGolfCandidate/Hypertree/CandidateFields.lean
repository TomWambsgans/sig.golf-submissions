...
theorem verificationBound : submission.VerificationBound 1690289 := by
  intro hash secretKey message
  dsimp only
  intro _
...
theorem certificate_of_secure (security : submission.Secure) : Certificate submission 1690289 :=
